...
def is_phishing(message):
    ...
    keywords = [
        ...
        "password expired", "suspicious activity", "unauthorized access", "action required", "claim", "won"
    ]
...
def highlight_phishing_indicators(message):
    indicators = [
        ...
        "your account has been suspended", "unusual activity detected", "legal action", "last warning", "action required", "claim", "won"
    ]
